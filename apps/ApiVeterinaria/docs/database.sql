...
CREATE DATABASE IF NOT EXISTS veterinaria_bd
...
('Juan Pérez', 'juan.perez@ejemplo.com', '+52 55 1234-5678', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('María García', 'maria.garcia@ejemplo.com', '+52 55 2345-6789', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Carlos López', 'carlos.lopez@ejemplo.com', '+52 55 3456-7890', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Ana Martínez', 'ana.martinez@ejemplo.com', '+52 55 4567-8901', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Luis Rodríguez', 'luis.rodriguez@ejemplo.com', '+52 55 5678-9012', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Elena Fernández', 'elena.fernandez@ejemplo.com', '+52 55 6789-0123', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Miguel Torres', 'miguel.torres@ejemplo.com', '+52 55 7890-1234', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Patricia Ruiz', 'patricia.ruiz@ejemplo.com', '+52 55 8901-2345', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Roberto Jiménez', 'roberto.jimenez@ejemplo.com', '+52 55 9012-3456', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu'),
('Carmen Morales', 'carmen.morales@ejemplo.com', '+52 55 0123-4567', '$2a$12$vuIJ6Z90FQfIFLlaatJlF.QVUhIO.o86u28tawMZOtz4zm5UGH8wu');
...
-- mysqldump -u [usuario] -p veterinaria_bd > backup_usuarios.sql

-- Comando para restaurar (ejecutar desde terminal):
-- mysql -u [usuario] -p veterinaria_bd < backup_usuarios.sql
