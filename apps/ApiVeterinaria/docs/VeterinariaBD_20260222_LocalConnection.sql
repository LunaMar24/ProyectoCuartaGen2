...
INSERT INTO `citas` VALUES (1,11,'2026-02-24 14:00:00','2026-02-24 14:30:00','C','Dolor de panza','Presenta vómitos y diarrea',1,'2026-02-22 00:53:41',1,'2026-02-22 18:22:44'),(2,5,'2026-02-24 09:30:00','2026-02-24 10:00:00','C','Para corte de uñas',NULL,1,'2026-02-22 01:07:06',NULL,'2026-02-22 15:09:42'),(3,4,'2026-02-24 09:00:00','2026-02-24 09:30:00','F','Baño completo',NULL,1,'2026-02-22 01:12:19',1,'2026-02-22 18:33:23'),(4,11,'2026-02-25 16:30:00','2026-02-25 17:00:00','T','Limpieza de oídos','Los tiene muy sucios',1,'2026-02-22 14:39:39',1,'2026-02-22 18:46:08'),(5,4,'2026-02-20 11:30:00','2026-02-20 12:00:00','N','prueba 3',NULL,1,'2026-02-22 15:20:42',NULL,'2026-02-22 15:21:06');
...
CREATE TABLE `historial_medico` (
  ...
  UNIQUE KEY `uk_historial_cita` (`citaId`),
  KEY `fk_Historial_Medico_Mascota1_idx` (`Mascota`),
  CONSTRAINT `fk_historial_cita` FOREIGN KEY (`citaId`) REFERENCES `citas` (`idCita`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `historial_medico` VALUES (2,5,'2025-11-03 01:08:00','Dolor de panza','Gastroenteritis aguda',NULL),(3,5,'2025-11-04 02:03:00','corte de uñas','arreglo por picos en uñas',NULL),(7,4,'2025-11-03 14:21:00','atropello','patita quebrada',NULL),(8,5,'2025-11-03 14:57:00','desparacitacion','se desparacito por presentar pequeños vomitos',NULL),(9,11,'2026-02-22 18:45:00','Limpieza de oídos','Se encontró en la limpieza una pequeña infección producto de la cerilla. Se mandan antibióticos cada 8 hrs por 3 días',4);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_crear_historial_y_cerrar_cita` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_crear_historial_y_cerrar_cita`(
    IN p_idCita INT,
    IN p_mascotaId INT,
...
-- Dump completed on 2026-02-22 18:48:41
